/**
 * Following sample is adopted from original lettercount sample from 
...
/**
 * <p>The Letter count sample counts the number of letter occurrences within a set of input documents 
 * using MapReduce. The code has three parts: mapper, reducer, and the main program.</p>
 * @author Amish shah, created from Srinath Perera (srinath@wso2.com)
 */
public class LetterCount {
  ...
  public static class TokenizerMapper 
    ...
    public void map(Object key, Text value, Context context
    	...
    	char[] inputChar = value.toString().toCharArray();
    	for(int inputPtr =0; inputPtr < inputChar.length-1; inputPtr++)
    	{
    	   int inputCharI = inputChar[inputPtr];
    	   if(inputCharI >= 97 && inputCharI < 122)
    	   {
    		   word.set(inputChar[inputPtr]+"");
